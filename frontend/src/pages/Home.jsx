    ...
    <div className="min-h-screen">
      ...
      <section className="hero-bg py-24 relative">
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          <span className="inline-block mb-6 px-4 py-1.5 text-sm rounded-full border border-white/20 bg-white/10 backdrop-blur">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Write and test code in real-time with instant feedback and detailed explanations</p>
            </div>
            ...
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Earn badges, unlock achievements and compete on leaderboards while learning</p>
            </div>
            ...
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Visualize your learning journey with detailed analytics and performance metrics</p>
            </div>
            ...
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Connect with peers, share solutions, and get help from experienced mentors</p>
            </div>
            ...
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Earn recognized certifications upon completing courses and mastering skills</p>
            </div>
            ...
            <div className="glow-card rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Learn at your own speed with flexible schedules and lifetime access</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="rounded-2xl p-8 bg-[#14141c]/70 border border-white/10">
            <div className="rounded-xl p-6 card-strong mb-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold">Active Courses</h3>
                <span className="text-sm text-gray-400">Your current learning paths</span>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className={`rounded-lg p-4 border-l-4 border-${course.color}-400 bg-[#16161f]`}>
                    <div className="flex justify-between mb-2">
                      <div>
                        <h4 className="font-semibold">{course.title}</h4>
                        <p className="text-sm text-gray-400">Lessons: {course.lessons}</p>
                      </div>
      ...
      {/* CTA */}
      <section className="py-20 cta-bg text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Link to="/signup" className="bg-white text-gray-900 px-10 py-4 rounded-xl font-semibold hover:bg-gray-200 transition text-lg shadow-xl inline-block">
              Start Learning Now →
            </Link>

            <Link to="/courses" className="border-2 border-white text-white px-10 py-4 rounded-xl font-semibold hover:bg-white/10 transition text-lg shadow-lg inline-block">
              Explore Courses
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold">Yaksh</span>
              </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">pythonsupport@fossee.com</p>
            </div>
          </div>

          <div className="border-t border-white/10 pt-6 flex justify-between text-sm text-gray-500 flex-wrap gap-4">

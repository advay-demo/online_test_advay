                                ...
                                return (
                                    <div key={course.course_id} className="mb-4">
                                        <div 
                                            ...
                                            className={`cursor-pointer card p-4 sm:p-5 rounded-xl border-2 border-[var(--border-medium)] hover:shadow-lg hover:border-blue-500/70 dark:hover:border-blue-500/50 transition-all duration-300 group hover:shadow-md bg-[var(--surface)] ${isExpanded ? 'border-blue-500/70 dark:border-blue-500/50' : ''}`}
                                        >
                                            <div className="flex flex-col sm:flex-row items-start gap-4">
                                                ...
                                                <div className="flex items-center gap-2 w-full sm:w-auto sm:self-start flex-shrink-0">
                                                    <button
                                                        onClick={(e) => { e.stopPropagation(); toggleCourseDetails(course.course_id); }}
                                                            ...
                                                            <ul className="space-y-3">
                                                                {course.quizzes.map((quiz) => {
                                                                    ...
                                                                    return (
                                                                        <li
                                                                            key={quiz.id}
                                                                            onClick={() => navigate(`/teacher/courses/${course.course_id}/manage`)}
                                                                            className="cursor-pointer card-strong p-4 rounded-xl border-2 border-[var(--border-medium)] hover:shadow-md hover:bg-white/[0.02] transition-all duration-300 group"
                                                                                ...
                                                                                <div className="flex-1 min-w-0">
                                                                                    ...
                                                                                    <div className="flex items-center justify-between flex-wrap gap-2">
                                                                                        ...
                                                                                        <div className="flex gap-2">
                                                                                            <Link
                                                                                                to="#"
                                                                                                onClick={(e) => { e.preventDefault(); e.stopPropagation(); onMonitorClick(quiz, course); }}
                                                                                            ...
                                                                                            <Link
                                                                                                to="#"
                                                                                                onClick={e => { e.preventDefault(); e.stopPropagation(); onGradeClick(quiz, course); }}
